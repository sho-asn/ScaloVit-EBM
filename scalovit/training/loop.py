"""Training loop for the ScaloViT energy-based model."""
...
try:
    ...
    raise ImportError("You need to install torchcfm: pip install torchcfm") from exc
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--train_data_path", type=str, default="preprocessed_dataset/train_chunks_wavelet_mag.pt", help="Path to the training data chunks file.")
    parser.add_argument("--val_data_path", type=str, default="preprocessed_dataset/val_chunks_wavelet_mag.pt", help="Path to the validation data chunks file.")
    ...
    parser.add_argument("--channel_mult", type=int, nargs="+", default=[1, 2, 2, 2], help="Channel multipliers for each U-Net resolution block.")
...
def forward_all(
    ...
    x_real_flow: torch.Tensor,
    x_real_cd: torch.Tensor,
...
def train(args: argparse.Namespace) -> None:
    ...
    _, channels, height, width = train_chunks.shape
    print(f"Detected data shape: C={channels}, H={height}, W={width}")
